# logic-error-tool
A tool to detect and correct logic errors in models of computer programs ('Final Year Project' for my degree programme).
...
![The end user inputs a loop.](https://github.com/nathangjdf/logic-error-tool/assets/92447278/cdfbf4c8-e269-455a-9276-bb7fdee38ec4)

LET in Apple macOS.

![LET finds an infinite loop error and suggests corrections.](https://github.com/nathangjdf/logic-error-tool/assets/92447278/2b58e86b-94b7-4732-9d84-72b5445848fa)
...
![The end user inputs instructions and the arithmetic expression they expect to represent the instructions.](https://github.com/nathangjdf/logic-error-tool/assets/92447278/a2cbd71b-44f1-4eff-a381-93151672af2f)

![LET finds an arithmetic expression error and suggests a correction.](https://github.com/nathangjdf/logic-error-tool/assets/92447278/c340f965-e8ef-493c-a089-f968b53d32ed)
...
![The end user inputs an array position range and a loop they expect to traverse the array at the corresponding index range.](https://github.com/nathangjdf/logic-error-tool/assets/92447278/d03838fd-d1c2-4b26-9a9d-5a1aa0907e20)

![LET finds an error that is likely off-by-one and suggests corrections.](https://github.com/nathangjdf/logic-error-tool/assets/92447278/05edf9f1-002d-47f6-80ec-6136a98dfc95)
...
![The end user inputs string instance variables, constructors, and initialisations.](https://github.com/nathangjdf/logic-error-tool/assets/92447278/c3d61366-c577-464b-91f1-396ddc741f5f)

![LET finds a null pointer error and suggests a correction.](https://github.com/nathangjdf/logic-error-tool/assets/92447278/9ba3d5d3-928a-49ab-96c4-a212fc88ba9d)
...
Please see the 'Overview of software' and 'Using software' sections of [the User Guide](https://github.com/nathangjdf/logic-error-tool/wiki/User-Guide).

# Where can users can get help with the project?
Please go to [this repository's 'Wiki' tab](https://github.com/nathangjdf/logic-error-tool/wiki).
